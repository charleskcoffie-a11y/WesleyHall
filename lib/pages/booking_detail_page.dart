                ...
                DropdownButtonFormField<String>(
                  ...
                  items: const [
                    DropdownMenuItem(
                        ...
                        child: Text('Booking Deposit')),
                    DropdownMenuItem(
                        value: 'rental_balance',
                        child: Text('Rental Balance')),
                    DropdownMenuItem(
                        value: 'damage_deposit',
                        child: Text('Damage Deposit')),
                    DropdownMenuItem(
                        value: 'damage_refund',
  ...
  Widget build(BuildContext context) {
    ...
    final depositDue =
        (b.requiredBookingDeposit - b.bookingDepositPaid)
            ...
            .toDouble();
    final damageDue =
        (b.damageDepositRequired - b.damageDepositHeld)
            .clamp(0.0, double.infinity)
            .toDouble();
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'Print the hall rental agreement for the client to review and sign.',
                          ),
                        ],
                      ),
                    ),
                    FilledButton.icon(
                      onPressed: printContract,
                      icon: const Icon(Icons.print_outlined),
                      label: const Text('Print Contract for Signature'),
                    ),
                  ],
                ),
              ),
                  ...
                  children: [
                    Row(
                      children: [
                        Expanded(
                          child: Text(
                            '${b.eventDetails} • ${b.hallSpaceName}',
                          ...
                          rows: b.payments.map((p) {
                            return DataRow(
                              cells: [
                                ...
                                DataCell(
                                    Text(p.paymentType.replaceAll('_', ' '))),
